...
var App = function() {
    ...
    var uiLayoutApi = function($mode) {
        ...
        switch($mode) {
            ...
            case 'sidebar_mini_toggle':
                ...
                if ($("#page-container.sidebar-mini").length) {
                    createCookie('menu', 'close', 5);
                } else {
                    createCookie('menu', 'open', 5);
                }
    ...
    var uiBlocksApi = function($block, $mode) {
        ...
        var $iconFullscreen = 'fa fa-expand';
        var $iconFullscreenActive = 'fa fa-compress';
        var $iconContent = 'fa fa-caret-up';
        var $iconContentActive = 'fa fa-caret-down';
